(function () {
	...
	var htmx_esm = /*#__PURE__*/Object.freeze({
		__proto__: null,
		default: htmx
	});

	var require$$0 = /*@__PURE__*/getAugmentedNamespace(htmx_esm);

	var hasRequiredFin;

	function requireFin () {
		if (hasRequiredFin) return fin;
		hasRequiredFin = 1;
		window.htmx = require$$0;
		return fin;
	}

	var finExports = requireFin();
	var index = /*@__PURE__*/getDefaultExportFromCjs(finExports);
